...
int main() {
    ...
    std::cout << "\nYour Camel:\n";
    selectedCamel.displayInfo();
    std::cout << "\n" << playerName << ", you are ready to begin Marco Polo's Journey!\n";
    ...
    for (size_t i = 0; i < journeyStops.size(); ++i) {
        ...
        if (i == 5 && currentStop.getName() == "Kublai Khan's Court") {
            std::cout << "\n*** KUBLAI KHAN'S GIFT ***\n";
            std::cout << "The great Khan presents " << playerName << " with a Golden Passport!\n";
        ...
        if (i == 10 && currentStop.getName() == "Return Journey - India") {
            std::cout << "\n*** SAD NEWS ***\n";
            std::cout << playerName << ", you learn that Kublai Khan has passed away...\n";
        ...
        if ((i == 1 && currentStop.getName() == "Mediterranean Sea Voyage")) {
            ...
            std::cout << "\n*** OCEAN VOYAGE AHEAD ***\n";
            std::cout << playerName << ", you will use your selected boat: " << selectedBoat.getType() << "\n";
    ...
    std::cout << "\n\n=== Journey Complete ===\n";
    std::cout << playerName << ", you have successfully completed Marco Polo's journey!\n";
